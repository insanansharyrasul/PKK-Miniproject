...
| **Memetic PSO** | **784,61 km** | **~15,73 s** | **+12,03%** |

PSO berhasil menghemat **107,33 km** dibanding baseline Greedy dengan _seed_ 42, preset Exploitation-Heavy (`w=0.4, c1=1.0, c2=2.0`, 15 partikel), dan _early stopping_ di iterasi ke-80.
